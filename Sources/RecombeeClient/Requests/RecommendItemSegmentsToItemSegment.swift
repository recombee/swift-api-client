...
public struct RecommendItemSegmentsToItemSegment: Request {
    ...
    public init(contextSegmentId: String, targetUserId: String, count: Int, scenario: String? = nil, cascadeCreate: Bool? = true, filter: String? = nil, booster: String? = nil, logic: Logic? = nil, expertSettings: JSONDictionary? = nil, returnAbGroup: Bool? = nil, reqlExpressions: JSONDictionary? = nil) {
