...
public struct RecommendItemsToItem: Request {
    ...
    public var userImpact: Double? = nil
    ...
    /// Initializes RecommendItemsToItem request
    /// - Parameters:
    ...
    public init(itemId: String, targetUserId: String, count: Int, scenario: String? = nil, cascadeCreate: Bool? = true, returnProperties: Bool? = nil, includedProperties: [String]? = nil, filter: String? = nil, booster: String? = nil, logic: Logic? = nil, reqlExpressions: JSONDictionary? = nil, userImpact: Double? = nil, diversity: Double? = nil, minRelevance: String? = nil, rotationRate: Double? = nil, rotationTime: Double? = nil, expertSettings: JSONDictionary? = nil, returnAbGroup: Bool? = nil) {
        self.itemId = itemId
    ...
    public var path: String { "/recomms/items/\(itemId)/items/" }
