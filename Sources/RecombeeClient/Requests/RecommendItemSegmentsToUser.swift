...
public struct RecommendItemSegmentsToUser: Request {
    ...
    public init(userId: String, count: Int, scenario: String? = nil, cascadeCreate: Bool? = true, filter: String? = nil, booster: String? = nil, logic: Logic? = nil, expertSettings: JSONDictionary? = nil, returnAbGroup: Bool? = nil, reqlExpressions: JSONDictionary? = nil) {
        self.userId = userId
        self.count = count
