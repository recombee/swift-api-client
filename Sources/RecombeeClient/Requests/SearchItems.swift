...
public struct SearchItems: Request {
    ...
    public init(userId: String, searchQuery: String, count: Int, scenario: String? = nil, cascadeCreate: Bool? = true, returnProperties: Bool? = nil, includedProperties: [String]? = nil, filter: String? = nil, booster: String? = nil, logic: Logic? = nil, reqlExpressions: JSONDictionary? = nil, expertSettings: JSONDictionary? = nil, returnAbGroup: Bool? = nil) {
        self.userId = userId
